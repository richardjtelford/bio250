...
Important arguments you need to set are `ages`, `ageSds`, and `positions` (i.e depth). See the example in the helpfile for how to do this. The `calCurves` argument will default to "intcal20", which is what we want, so it does not need changing. 
